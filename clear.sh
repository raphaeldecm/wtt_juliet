...
# Remove Logs
rm log_afl_bad.txt log_afl_good.txt read_ft.txt read_rtc.txt log_good.txt log_bad.txt time.csv categorization_bad.log categorization_good.log flawfinder_all.txt flawfinder_filter.txt testedfunctions.log compile.log
